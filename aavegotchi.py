...
gotchi2_display = gotchi[['name','brs', 'mbrs']]
...
st.write("Top 100, sorted by rarity per GHST")
st.table(portals_display.sort_values(by=['brs/ghst'], ascending=False).head(100))
